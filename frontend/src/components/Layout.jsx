        ...
        <div className="flex items-center gap-3">
          <div style={{ position: 'relative', flexShrink: 0, width: 40, height: 40, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <svg width="34" height="34" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle cx="16" cy="16" r="14" fill="#8b5cf6" fillOpacity="0.15" stroke="#a78bfa" strokeWidth="1" strokeOpacity="0.6" />
              <circle cx="16" cy="16" r="8" stroke="#818cf8" strokeWidth="1.5" strokeOpacity="0.9" />
              <ellipse cx="16" cy="16" rx="8" ry="3" transform="rotate(45 16 16)" stroke="#a78bfa" strokeWidth="1.5" strokeOpacity="0.9" />
              <ellipse cx="16" cy="16" rx="8" ry="3" transform="rotate(-45 16 16)" stroke="#60a5fa" strokeWidth="1.5" strokeOpacity="0.9" />
